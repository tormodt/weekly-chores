...
import { SimpleFirestoreService } from './firebase-types.js';
export class SimpleFirestoreService {
    ...
    async addTask(task) {
        ...
        try {
            ...
            const docRef = await firebaseUtils.addDoc(firebaseUtils.collection(this.db, `years/${year}/weeks/${week}/tasks`), taskData);
